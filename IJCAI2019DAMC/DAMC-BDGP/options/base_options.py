...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--input_nA', type=int, default=1750, help='# of input image channels')
        self.parser.add_argument('--input_nB', type=int, default=79, help='# of input image channels')
