...
#        print('saved...')
        ...
        data_0 = scipy.io.loadmat('rand1/paired_a25003_100.mat')
        data_dict=dict(data_0)
        data_1 = data_dict['xpaired']
        data_2 = scipy.io.loadmat('rand1/paired_b25003_100.mat')
        data_dict=dict(data_2)
        data_3 = data_dict['ypaired']
        data_a = np.zeros((self.paried_num, 1, 1750))
        data_b = np.zeros((self.paried_num, 1, 79))
